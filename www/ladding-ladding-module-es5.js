...
var LaddingPageModule = /** @class */ (function () {
    function LaddingPageModule() {
    }
...
var LaddingPage = /** @class */ (function () {
    function LaddingPage(authService, router) {
    ...
    LaddingPage.prototype.ngOnInit = function () {
    };
    LaddingPage.prototype.skipLadding = function () {
        var _this = this;
        this.authService.updateLadding(false).then(function (res) {
            _this.router.navigate(['/dashboard/tab1']);
        });
    };
    LaddingPage.ctorParameters = function () { return [
...
//# sourceMappingURL=ladding-ladding-module-es5.js.map